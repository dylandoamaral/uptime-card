  ...
  private _initialize(): void {
    ...
    this.options = {
      ...
      customization: {
        ...
        properties: [
          ...
          },
          {
            ...
            default: DEFAULT_CONFIG.title_template,
          },
          {
            type: 'input',
          ...
          },
          {
            ...
            default: DEFAULT_CONFIG.average_template,
          },
          {
            type: 'switch',
      ...
      clip: {
        ...
        name: 'Clip customization',
        description: 'Customize max length of texts',
        show: false,
        properties: [
          {
            name: 'title',
            type: 'number',
            label: 'The max length of the title before clipping.',
            section: 'clip',
            min: 0,
            max: 100,
            default: DEFAULT_CLIP.title,
          },
          {
            name: 'status',
            type: 'number',
            label: 'The max length of the status before clipping.',
            section: 'clip',
            min: 0,
            max: 100,
